...
if (finals[0]['Home Team Goals'] > finals[0]['Away Team Goals']) {
    console.log(`The winner is ${finals[0]['Home Team Name']}`) 
    } else {
        console.log(`The winner is ${finals[0]['Away Team Name']}`) 
    };
...
function getCountryWins(data, teamInitial) {
    let result = {};
    let homeTeamInitial = data['Home Team Initials'];
    let awayTeamInitial = data['Home Team Initials'];
